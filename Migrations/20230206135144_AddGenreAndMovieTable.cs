...
{
    public partial class AddGenreAndMovieTable : Migration
    {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);// Restrict بدل Cascade علشان ما يحذف الافلام عند حذف الفئة اللي تحتويها
                });
